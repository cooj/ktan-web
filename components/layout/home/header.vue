                ...
                <nav>
                    <ul class="flex">
                        <li v-for="item in menuList.filter(i => i.status)" :key="item.id" class="nav_list"
                            ...
                            <!-- 子菜单列表 -->
                            <div v-if="item.children?.length" class="nav_hide">
        ...
        <div class="navs_module">
            <div class="navs_box">
                ...
                <nav>
                    <ul class="navs_ul">
                        <li class="navs_li">
                            <a href="" class="navs_btn">首页</a>
                        </li>
                        <li class="navs_li">
                            <a href="aboutUs.html" class="navs_btn">关于我们</a>
                        </li>
                        <li class="navs_li">
                            <a href="center-zh-Hans.html" class="navs_btn">产品中心</a>
                        </li>
                        <li class="navs_li">
                            <a href="center-zh-Hans1.html" class="navs_btn">新闻中心</a>
                        </li>
                        <li class="navs_li">
                            <a href="serviceAndSupport.html" class="navs_btn">服务与支持</a>
                        </li>
                        <li class="navs_li">
                            <a href="recruitment.html" class="navs_btn">人才招聘</a>
                        </li>
                        <li class="navs_li">
                            <a href="contactUs.html" class="navs_btn">联系我们</a>
                        </li>
                    </ul>
                </nav>
            </div>
